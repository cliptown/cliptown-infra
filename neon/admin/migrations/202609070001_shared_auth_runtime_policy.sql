...
INSERT INTO cliptown.shared_auth_runtime_policy(provider,data_plane,contract_version,github_org,runtime_org,target_org,database_url_env,decision_mode,server_roles)VALUES('neon','admin-auth',1,'cliptown','cliptown','cliptown','NEON_ADMIN_DATABASE_URL','strict-paired',ARRAY['admin-web-server','admin-api-server'])ON CONFLICT DO NOTHING;
COMMIT;
