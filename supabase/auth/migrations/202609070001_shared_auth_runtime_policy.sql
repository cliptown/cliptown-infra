...
INSERT INTO cliptown.shared_auth_runtime_policy(provider,data_plane,contract_version,github_org,runtime_org,target_org,database_url_env,decision_mode,server_roles)VALUES('supabase','customer-auth',1,'cliptown','oresoftware','cliptown','SUPABASE_AUTH_DATABASE_URL','availability-first',ARRAY['web-server','api-server'])ON CONFLICT DO NOTHING;
COMMIT;
